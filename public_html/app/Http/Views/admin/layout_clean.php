<?php
/**
 * Clean Admin Layout - FIXED NAVIGATION LINKS
 * 
 * Modern, lean design with corrected routes matching actual route definitions
 * Author: GitHub Copilot + UI Autopatcher  
 * Created: 2025-09-13
 * Fixed: 2025-09-14 - Corrected broken navigation links
 */
...
<body>
        ...
        <div class="user-menu">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="/admin/settings"><i class="bi bi-person me-2"></i>Profile</a></li>
    ...
    <!-- Sidebar - FIXED NAVIGATION LINKS -->
    <aside class="sidebar">
        <ul class="sidebar-menu">
            ...
            <!-- FIXED: /admin/security -> /admin/system (route exists) -->
            <li><a href="/admin/system">
                <i class="bi bi-shield-lock"></i>
                <span>System</span>
            </a></li>
            
            <!-- FIXED: /admin/performance -> /admin/analytics (route exists) -->
            <li><a href="/admin/analytics">
                <i class="bi bi-graph-up"></i>
                <span>Analytics</span>
            </a></li>
            
            <!-- FIXED: /admin/database -> /admin/database/prefix-manager (specific route exists) -->
            <li><a href="/admin/tools">
                <i class="bi bi-database"></i>
                <span>Database Tools</span>
            </a></li>
            
            <!-- REMOVED: /admin/backups (no route exists) - Will add route later -->
