<?php
/**
 * CIS 2.0 Live Admin Interface - Production Ready
 * 
 * Functional admin demonstration for cis.dev.ecigdis.co.nz
 * showcasing real backend features including Cache Management, 
 * Queue System, Database Tools, and more.
 * 
 * @author CIS System Architect Bot
 * @version 2.0.0
 * @created 2025-01-16
 * @domain cis.dev.ecigdis.co.nz
 */
...
$baseUrl = 'https://cis.dev.ecigdis.co.nz';
...
$adminModules = [
    ...
    'database' => [
        ...
        'url' => $baseUrl . '/admin/database/prefix-manager',
    ...
    'integrations' => [
        ...
        'url' => $baseUrl . '/admin/integrations',
...
<head>
    ...
    <title>CIS 2.0 - Live Admin Interface | <?= $baseUrl ?></title>
...
<body>
    ...
    <div class="admin-header d-flex align-items-center px-4">
        <div class="d-flex align-items-center">
            ...
            <div class="production-badge ms-3">PRODUCTION</div>
        </div>
        <div class="ms-auto d-flex align-items-center">
            <span class="live-indicator me-2"></span>
            <small>Live System @ <?= $baseUrl ?></small>
            <div class="ms-4">
    ...
    <div class="d-flex">
        ...
        <div class="admin-sidebar">
            <div class="p-3">
                ...
                <div class="px-3">
                    <h6 class="text-muted text-uppercase mb-3">Quick Links</h6>
                    <div class="d-grid gap-2">
                        <a href="<?= $baseUrl ?>/admin" class="btn btn-outline-primary btn-sm" target="_blank">
                            <i class="fas fa-external-link-alt me-1"></i>Live Admin
                        </a>
                        <a href="<?= $baseUrl ?>" class="btn btn-outline-secondary btn-sm" target="_blank">
        ...
        <div class="admin-content">
            ...
            <div class="mb-4">
                ...
                <p class="text-muted">Live overview of your CIS 2.0 system performance and health at <strong><?= $baseUrl ?></strong></p>
            </div>
                            ...
                            <div class="card module-card h-100">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="<?= $moduleInfo['url'] ?>" class="btn btn-sm btn-primary" target="_blank">
                                            <i class="fas fa-external-link-alt me-1"></i>Open Live
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Domain Information</h6>
                        </div>
                        <div class="card-body">
                            <table class="table table-sm">
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-success">Production Ready</span></td>
                                </tr>
                            </table>
                        </div>
                    </div>
            ...
            <div class="mb-4">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ms-auto">
                        <a href="<?= $moduleInfo['url'] ?>" class="btn btn-primary" target="_blank">
                            <i class="fas fa-external-link-alt me-1"></i>Open Live Module
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Module Interface Preview</h5>
                        </div>
                        <div class="card-body">
                            <?php if ($module === 'cache'): ?>
                            ...
                            <div class="alert alert-info">
                                ...
                                <strong>Live Cache Management:</strong> This module provides real-time Redis cache monitoring and management capabilities.
                            </div>
                            ...
                            <div class="alert alert-info">
                                <i class="fas fa-info-circle me-2"></i>
                                <strong>Live Queue Management:</strong> This module provides comprehensive job queue monitoring and control.
                            </div>
                            ...
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted">Live URL: <code><?= $moduleInfo['url'] ?></code></p>
                                
                                <div class="mt-4">
                                    <a href="<?= $moduleInfo['url'] ?>" class="btn btn-primary btn-lg" target="_blank">
                                        <i class="fas fa-external-link-alt me-2"></i>Access Live Module
                                    </a>
                                </div>
                            </div>
                            <?php endif; ?>
                        ...
                        <div class="card-body">
                            <table class="table table-sm">
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?= $moduleInfo['url'] ?>" target="_blank" class="text-decoration-none"><?= $moduleInfo['url'] ?></a></td>
                                </tr>
                                <tr>
