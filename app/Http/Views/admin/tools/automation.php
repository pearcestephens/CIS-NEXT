<?php
/**
 * Automation & Verification Suite Page
 * File: app/Http/Views/admin/tools/automation.php
 * Purpose: Run comprehensive system tests, verifications, and automated processes
 * Extends: admin/layout.php
 */

// Page configuration
$title = 'Automation Suite';
$page_title = 'Automation & Verification Suite';
$page_description = 'Run comprehensive system tests, verifications, and automated processes';
$page_icon = 'fas fa-robot';
$page_header = true;

$page_actions = '
    <div class="d-flex align-items-center">
        <button id="refreshStatusBtn" class="btn btn-outline-info mr-2">
            <i class="fas fa-sync-alt"></i> Refresh Status
        </button>
        <button id="runAllSuitesBtn" class="btn btn-success">
            <i class="fas fa-play"></i> Run All Suites
        </button>
    </div>
';
