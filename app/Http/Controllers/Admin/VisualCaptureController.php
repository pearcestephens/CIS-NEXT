...
/**
 * Visual Capture Controller - Screenshot testing tool
 */
class VisualCaptureController
{
    ...
    public function __construct()
    {
        ...
        $this->screenshotsDir = dirname(__DIR__, 4) . '/var/screenshots';
        
        // Ensure screenshots directory exists
        @mkdir($this->screenshotsDir, 0755, true);
        @mkdir($this->screenshotsDir . '/' . date('Ymd'), 0755, true);
    }

    /**
     * Display visual capture interface
     */
    public function index(): string
    {
        ...
        <head>
            ...
            <title>Visual Capture Tool - CIS Admin</title>
            <meta name="csrf-token" content="<?= htmlspecialchars($this->getCsrfToken()) ?>">
